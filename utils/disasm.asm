...
0000000000400274 <.note.gnu.build-id>:
  ...
  400283:	00 87 a6 3d 32 2b    	add    %al,0x2b323da6(%rdi)
  400289:	aa                   	stos   %al,%es:(%rdi)
  40028a:	ce                   	(bad)  
  40028b:	b6 6a                	mov    $0x6a,%dh
  40028d:	50                   	push   %rax
  40028e:	03 26                	add    (%rsi),%esp
  400290:	a0                   	.byte 0xa0
  400291:	82                   	(bad)  
  400292:	9c                   	pushfq 
  400293:	9b                   	fwait
  400294:	80 76 02 8d          	xorb   $0x8d,0x2(%rsi)
...
0000000000400420 <deregister_tm_clones>:
  400420:	b8 30 10 60 00       	mov    $0x601030,%eax
  400425:	48 3d 30 10 60 00    	cmp    $0x601030,%rax
  ...
  400437:	bf 30 10 60 00       	mov    $0x601030,%edi
...
0000000000400450 <register_tm_clones>:
  ...
  400455:	48 81 ee 30 10 60 00 	sub    $0x601030,%rsi
  ...
  400479:	bf 30 10 60 00       	mov    $0x601030,%edi
...
0000000000400588 <__FRAME_END__-0xe8>:
  ...
  400633:	8c 05 48 0e 30 86    	mov    %es,-0x79cff1b8(%rip)        # ffffffff86701481 <_end+0xffffffff86100449>
  400639:	06                   	(bad)  
...
0000000000000000 <.comment>:
  ...
  11:	30 2d 31 30 75 62    	xor    %ch,0x62753031(%rip)        # 62753048 <_end+0x62152010>
