...
// for loop equivalent for printing the n number of lines of OPERATOR_LITERAL(n);
OPERATOR_LITERAL(2);
OPERATOR_LITERAL(3);
OPERATOR_LITERAL(4);
OPERATOR_LITERAL(5);
...
// TODO: Stress and check the boundary conditions OPERATOR_LITERAL(INT_MAX); and so on...
